  ...
  return (
    <div className="bg-gray-900 py-10">
      <Controller className="grid gap-5">
        ...
        <div>
          <p className="text-2xl text-gray-100 text-center sm:text-start">
            Avto-Layner Xorazm
          </p>
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-5 gap-10 mt-5">
            ...
            <span>
              <p className="text-gray-100 font-bold text-center sm:text-start">
                Выбор и покупка
              </p>
              <span className="flex flex-col items-start gap-2 mt-2">
                <Button
                  variant="link"
                  className="text-gray-300 font-sans p-0 block mx-auto sm:m-0"
                >
            ...
            <span>
              ...
              <span className="flex flex-col items-start gap-2 mt-2">
                <Button
                  ...
                  className="text-gray-300 font-sans p-0 block mx-auto sm:m-0"
                >
                  Новый бренд Avto-Layner Xorazm
                </Button>
                <Button
                  variant="link"
                  className="text-gray-300 font-sans p-0 block mx-auto sm:m-0"
                >
                  История Avto-Layner Xorazm
                </Button>
                <Button
                  variant="link"
                  className="text-gray-300 font-sans p-0 block mx-auto sm:m-0"
            ...
            <span>
              <p className="text-gray-100 font-bold text-center sm:text-start">
                Avto-Layner Xorazm в Узбекистане
              </p>
              <span className="flex flex-col items-start gap-2 mt-2">
                <Button
                  variant="link"
                ...
                <Button
                  ...
                  className="text-gray-300 font-sans p-0 block mx-auto sm:m-0"
                >
                  Станьте дилером Avto-Layner Xorazm
                </Button>
              </span>
            </span>
        ...
        <div>
          <p className="text-gray-300">Avto-Layner Xorazm {t("in-networks")}</p>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 items-center mt-5 gap-10">
          <p className="text-xs text-gray-300 sm:col-span-2">
            {t("footer-title-two")}
          </p>
          <Button
            variant="outline"
            className="text-gray-100 bg-gray-800 h-[60px]"
          >
            {t("feedback")}
          </Button>
        </div>
